...
const Skiper25 = () => {
    return (
        <div className="fixed bottom-24 right-10 z-50 flex items-center justify-center">
            <MusicToggleButton />
        </div>
    );
};
...
export const MusicToggleButton = () => {
    ...
    const [play, { pause, sound }] = useSound("/audio/Take It Easy - Karan Aujla.mp3", {
    ...
    return (
        <>
            <motion.div
                ...
                className="bg-black backdrop-blur-md border border-white/20 cursor-pointer rounded-full p-2 hover:bg-black/80 transition-colors"
            >
                <motion.div
