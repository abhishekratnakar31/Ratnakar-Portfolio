...
const ThreeDHoverGallery = ({
    ...
    itemWidth = 6, // Increased default for more width
    itemHeight = 25, // Increased default for more height
    ...
    const getItemStyle = (index) => {
        ...
        return {
            ...
            backgroundSize: isActive ? "contain" : "cover", // Show full image when active
    ...
    return (
        <div
            className={cn(
                "flex flex-col items-center justify-center h-screen w-full overflow-hidden bg-transparent select-none",
                className
            )}
